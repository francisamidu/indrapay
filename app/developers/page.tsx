      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-gray-400">
            Powerful APIs, comprehensive documentation, and developer tools that
            make integration simple and fast.
          </p>
          <div className="mt-10 flex justify-center items-center space-x-4">
            <Button variant="default" asChild>
              <Link href="/developers/api-documentation">
                View Documentation
              </Link>
            </Button>
            <Button variant="secondary" asChild>
              <Link href="/developers/sandbox">Try Sandbox</Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-400 mb-8">
                Our API is designed with simplicity and predictability in mind.
                Every endpoint follows REST conventions, returns JSON, and uses
