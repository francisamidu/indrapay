            ...
            {pricingTiers.map((tier, index) => (
              <div
                ...
                className={`bg-slate-900 p-8 flex flex-col justify-between rounded-2xl border ${
                  tier.popular ? "border-teal-500 relative" : "border-slate-800"
                }`}
              >
                {tier.popular && (
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-slate-800/50 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Funds are typically transferred to your bank account within 2-3
                business days after a successful transaction.
              </p>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-white mb-3">
              ...
              <p className="text-gray-400">
                We support all major credit and debit cards, mobile money, bank
                transfers, and popular local payment methods across different
                regions.
              </p>
            </div>
          </div>
