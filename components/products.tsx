            ...
            <ScrollReveal variants={fadeInUp}>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                  Everything you need to build global payment experiences. Hover
                  over each capability to explore our services.
                </p>
              </div>
            </ScrollReveal>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      Our payment flow is optimized for each market, and powered
                      by deep local insight in developed, developing and
                      emerging economies. From traditional banking rails to
                      mobile money, we give you payment technologies that truly
                      matter.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      We have built the world's premier real-time payment rails,
                      where 90% of transactions are instant. For the remaining
                      ones, you get full visibility over FX rates and fees and
                      real-time transaction status monitoring - so you know
